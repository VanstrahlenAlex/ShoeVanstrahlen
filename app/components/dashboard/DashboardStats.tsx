	...
	return (
		<div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4 ">
				<Card>
					...
					<CardContent>
						<p className="text-xl font-bold">${new Intl.NumberFormat('en-US').format( totalAmount / 100)}</p>
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-xs text-muted-foreground ">Total Sales on ShoeVanstrahlen</p>
					</CardContent>
				</Card>
				<Card>
					<CardHeader className="flex flex-row items-center justify-between pb-2">
